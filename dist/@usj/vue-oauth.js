(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('http'), require('https'), require('url'), require('assert'), require('stream'), require('tty'), require('util'), require('zlib')) :
	typeof define === 'function' && define.amd ? define(['exports', 'http', 'https', 'url', 'assert', 'stream', 'tty', 'util', 'zlib'], factory) :
	(factory((global['@usj/vueOauth'] = {}),global.http,global.https,global.url,global.assert,global.stream,global.tty,global.util,global.zlib));
}(this, (function (exports,http,https,url,assert,stream,tty,util,zlib) { 'use strict';
